...
bVals_small = bVals[rownames(bVals_summary[1:100000,]),]

bVals_Jung_small = bVals_Jung[rownames(bVals_summary[1:100000,]),]
saveRDS(bVals_Jung_small, file="../data/Jung_champnorm_small.rds")
bVals_Leanna_small = bVals_Leanna[rownames(bVals_summary[1:100000,]),]
saveRDS(bVals_Leanna_small, file="../data/WvT_champnorm_small.rds")
