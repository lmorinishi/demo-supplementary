...
```{r}
paste("Initial normal cluster purity:", initial_purity_normal)
paste("LDA normal cluster purity:", lda_purity_normal)

paste("Initial cancer cluster purity:", initial_purity_cancer)
paste("LDA cancer cluster purity:", lda_purity_cancer)
